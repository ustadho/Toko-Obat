...
//      });
    ...
    private void udfAddActionDaftar() {
        taskpane_daftar.add(new AbstractAction() {
            {
                putValue(Action.NAME, "Pelanggan");
...
//       this.setCursor(new Cursor(Cursor.DEFAULT_CURSOR));
    ...
    private void initComponents() {
        ...
        mnuMasterBarang.setText("Barang");
        ...
        mnuGRApproval.setText("Good Receipt Approval");
        ...
        mnuGRHistory.setText("Good Receipt HIstory");
        ...
        mnuTrx.setMnemonic('6');
        mnuTrx.setText("6. Alat");
        ...
        mnuHelp.setMnemonic('9');
        mnuHelp.setText("8. Help");
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jXStatusBar1, javax.swing.GroupLayout.DEFAULT_SIZE, 996, Short.MAX_VALUE)
...
//        }
    ...
    private apotek.JDesktopImage jDesktopPane1;
    ...
    public static String sNamaUsaha = "Apotek 'Narwastu'";
    public static String sAlamat = "";
    public static String sTelp = "Telp. ";
    public static String sKota="Sidoarjo";
