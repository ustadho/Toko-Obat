...
//                GeneralFunction.udfGetDouble(txtNewValue.getText()));
            try {
                String sQry = "INSERT INTO opname_detail(no_opname, kode_barang, " +
                        "expired_date, no_batch, jumlah_komp, jumlah_real, " +
                        "userins, time_ins, satuan, konv" +
                        ") "
...
//            opnameTable.setRowSelectionInterval(myModel.getRowCount()-1, myModel.getRowCount()-1);
    ...
    private void udfUpdateItem() {
        try {
            ...
            conn.createStatement().executeUpdate("UPDATE opname_detail "
                    ...
                    + "and no_batch='" + txtBatchNo.getText() + "'");
    ...
    private void udfSetSatuanBarang() {
        ...
        try {
            ...
            ResultSet rs = conn.createStatement().executeQuery(
                    "select satuan_kecil as sat_kecil, " +
                    "coalesce(satuan_besar,'') as sat_besar, coalesce(konversi,1) as konv " +
                    "from barang where item_code='" + txtKode.getText() + "'");
            if (rs.next()) {
                lstSatuan.add(rs.getString("sat_kecil"));
                cmbUnit.addItem(rs.getString("sat_kecil"));
                lstKonversi.add("1");
                if(rs.getString("sat_besar").length()>0){
                    lstSatuan.add(rs.getString("sat_besar"));
                    cmbUnit.addItem(rs.getString("sat_besar"));
                    lstKonversi.add(fn.intFmt.format(rs.getInt("konv")));
                }
            }
    ...
    private void udfLoadOpnameDetail(){
        try{
            ...
            ((DefaultTableModel) opnameTable.getModel()).setNumRows(0);
            ResultSet rs=null;
            rs = conn.createStatement().executeQuery("select d.kode_barang, coalesce(i.item_name,'') as nama_item, " +
                    ...
                    "and d.kode_barang||coalesce(i.item_name,'') ilike '%"+txtCari.getText()+"%' " +
    ...
    private void initComponents() {
        ...
        opnameTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kode", "Nama Barang", "Batch No.", "Exp. Date", "Unit", "Stok Komp", "Stok Real", "Konv"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Double.class, java.lang.Double.class, java.lang.Integer.class
            };
        ...
        panelAddItem.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 2, 240, -1));
        ...
        panelAddItem.add(txtNamaBarang, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 20, 240, 21));
        ...
        panelAddItem.add(txtCurrentQty, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 20, 60, 21));
        ...
        panelAddItem.add(txtNewQty, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 20, 60, 21));

        jLabel25.setBackground(new java.awt.Color(255, 255, 204));
        jLabel25.setText("Konv");
        jLabel25.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jLabel25.setOpaque(true);
        panelAddItem.add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 2, 30, -1));

        txtKonv.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtKonv.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        txtKonv.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        txtKonv.setEnabled(false);
        panelAddItem.add(txtKonv, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 20, 30, 21));
        ...
        txtBatchNo.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        txtBatchNo.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        txtBatchNo.setEnabled(false);
        panelAddItem.add(txtBatchNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 20, 90, 21));
        ...
        panelAddItem.add(txtExpDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 20, 70, 21));
            ...
            switch (evt.getKeyCode()) {
                ...
                default: {
                    if (!evt.getKeyText(evt.getKeyCode()).equalsIgnoreCase("Up") || !evt.getKeyText(evt.getKeyCode()).equalsIgnoreCase("F2")) {
                        String sQry = "select distinct i.item_code, coalesce(nama_paten,'') as nama_barang, coalesce(no_batch,''), coalesce(to_char(tanggal_kadaluwarsa,'dd/MM/yyyy'),'') as exp_date,"
                        ...
                        lst.setCompDes(new JComponent[]{txtNamaBarang, txtBatchNo, txtExpDate, txtCurrentQty, cmbUnit, txtKonv});
            ...
            if (c.equals(txtKode) && !lst.isVisible()) {
                ...
                try {
                    ResultSet rs = conn.createStatement().executeQuery(
                            ...
                            + "and coalesce(s.no_batch,'')='" + txtBatchNo.getText() + "' "
                    ...
                    if (rs.next()) {
                        ...
                        cmbUnit.removeAllItems();
                        cmbUnit.addItem(rs.getString("satuan_kecil"));
                        cmbUnit.setSelectedItem(rs.getString("satuan_kecil"));
                        txtKonv.setText("1");
                        //udfSetSatuanBarang();
                    }
