...
public class FrmUnplanned extends javax.swing.JInternalFrame {
    ...
    public FrmUnplanned(boolean b) {
        ...
        tblItem.getColumn("Price").setCellRenderer(new MyRowRenderer());
        tblItem.getColumn("Amount").setCellRenderer(new MyRowRenderer());
...
//                text.setEditable(vColIndex==tblItem.getColumnModel().getColumnIndex("On Receipt"));
            ...
            if(vColIndex==tblItem.getColumnModel().getColumnIndex("Price")||
        ...
        public Object getCellEditorValue() {
            ...
            try {
                ...
                }else if(col==tblItem.getColumnModel().getColumnIndex("Price")){
                    retVal = fn.udfGetDouble(((JTextField)text).getText());
                }
            ...
            if(mColIndex==0){
                ...
                try{
                    ...
                    if(rs.next()){
                        ...
                        ((DefaultTableModel)tblItem.getModel()).setValueAt(rs.getString("uom"), iRow, col.getColumnIndex("Uom"));
                        ((DefaultTableModel)tblItem.getModel()).setValueAt(stockPrice, iRow, col.getColumnIndex("Price"));
                ...
                for(int i=0; i<tblItem.getRowCount(); i++){
                    price=fn.udfGetDouble(tblItem.getValueAt(i, col.getColumnIndex("Qty")))*fn.udfGetDouble(tblItem.getValueAt(i, col.getColumnIndex("Price")));
                    totAmount+=price;
